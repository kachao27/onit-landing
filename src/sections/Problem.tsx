...
export default function Problem() {
  return (
    <section className="relative w-full h-[1390px] overflow-hidden bg-[#F0F0F0] antialiased">
      <ImageDithering
        ...
        className="absolute left-1/2 top-0 -translate-x-1/2 w-[1932px] h-[1444px] -mt-[54px]"
      />
      ...
      <div className="relative mx-auto w-[1440px] h-full">
        ...
        <div className="absolute top-[1110px] left-0 w-full h-[280px] bg-[#F0F0F0]">
